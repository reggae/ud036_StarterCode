...
# Instantiating classes of the type Movie (with movies starring Steve Martin)
la_story = media.Movie(
    "L.A. Story",
    "1h 38m",
...
roxanne = media.Movie(
    "Roxanne",
    "1h 47m",
    "This modernization of Edmond Rostand's Cyrano de Bergerac casts "
    "Steve Martin as C. D. Bales, "
    "the fearless, quick-witted fire chief of a Washington State resort town.",
    "https://upload.wikimedia.org/wikipedia/en/thumb/a/a7/Roxanne1987.jpg/250px-Roxanne1987.jpg",  # noqa
...
dirty_rotten_scoundrel = media.Movie(
